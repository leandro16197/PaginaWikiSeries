...
class ComentarioModel{
    ...
    function getComentarioSerie($id_serie){
        $sentencia=$this->db->prepare("SELECT comentario.id_comentario,comentario.comentario,comentario.fecha,comentario.puntaje,comentario.id_usuario,comentario.id_serie,usuario.nombre FROM comentario JOIN usuario on comentario.id_usuario=usuario.id_usuario WHERE comentario.id_serie=?  ORDER BY comentario.puntaje,comentario.fecha DESC");
